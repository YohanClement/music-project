...
public class AppController {
	...
	public String processRegister(Users user,@RequestParam("instruments") String instruments, @RequestParam("niveau") Integer niveau, @RequestParam("image") MultipartFile multipartFile) throws IOException {
	    ...
	    UsersInstruments uInst = new UsersInstruments(savedUser, instrRepo.findByinstrName(instruments), niveau);
